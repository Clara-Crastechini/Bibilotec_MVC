...
namespace Bibliotec.Contexts
{
    ...
    public class Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
                ...
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-D69BRM9\\SQLEXPRESS02; Initial Catalog = Bibliotec_mvc; User Id=sa; Password=123; TrustServerCertificate = true");
        ...
        public object LivroReservados { get; internal set; }
    }
}